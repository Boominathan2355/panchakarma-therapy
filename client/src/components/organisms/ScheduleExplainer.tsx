...
export interface ExplainerPhase {
    name: string;
    description: string;
    duration: string;
...
export interface ScheduleExplainerProps {
    explanations?: Explanations | null;
    onClose?: () => void;
}

const ScheduleExplainer: React.FC<ScheduleExplainerProps> = ({ explanations = null, onClose }) => {
                        ...
                        <div key={idx} className="phase-item">
                            <div className="phase-header" onClick={() => togglePhase(idx)}>
                                ...
                                <div className="phase-meta">
                                    ...
                                    {expandedPhases.has(idx) ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                                </div>
                            </div>
