...
interface SystemUser {
    ...
    name: string;
    email: string;
    role: 'Admin' | 'Physician' | 'Scheduler';
}
...
const SettingsPage: React.FC = () => {
    ...
    const [systemUsers, setSystemUsers] = useState<SystemUser[]>([
        ...
        { id: 2, name: 'Dr. Arya Sharma', email: 'doctor@ayursoft.com', role: 'Physician' },
        { id: 3, name: 'Dr. Rahul Verma', email: 'rahul@ayursoft.com', role: 'Physician' },
        { id: 4, name: 'Dr. Priya Nair', email: 'priya@ayursoft.com', role: 'Physician' },
        { id: 5, name: 'Dr. Amit Patel', email: 'amit@ayursoft.com', role: 'Physician' },
        { id: 6, name: 'Sarah Jones', email: 'sarah@ayursoft.com', role: 'Scheduler' },
        { id: 7, name: 'Arun Kumar', email: 'arun@ayursoft.com', role: 'Scheduler' },
        { id: 8, name: 'IT Support', email: 'it@ayursoft.com', role: 'Admin' },
    ]);
    const [newUser, setNewUser] = useState<Omit<SystemUser, 'id'>>({ name: '', email: '', role: 'Physician' });

    const handleAddUser = () => {
        if (!newUser.name || !newUser.email) return;
        const id = systemUsers.length > 0 ? Math.max(...systemUsers.map(u => u.id)) + 1 : 1;
        setSystemUsers([...systemUsers, { id, ...newUser } as SystemUser]);
                                ...
                                <div className="add-user-grid">
                                    ...
                                    <div className="form-group mb-0">
                                        ...
                                        <Input
                                            ...
                                            value={newUser.email}
                                            onChange={(e) => setNewUser({ ...newUser, email: (e.target as HTMLInputElement).value })}
                                        />
                                    </div>
                                    <div className="form-group mb-0">
                                        <Label>Role</Label>
                                        <select
                                            ...
                                            value={newUser.role}
                                            onChange={(e) => setNewUser({ ...newUser, role: (e.target as HTMLSelectElement).value as any })}
                                        >
